...
/// When [FindShadersResponse.fail] is *not null* there was an error in the find shaders call
/// When [FindShadersResponse.fail] is *null* the [FindShadersResponse.shaders] has the returned shaders
