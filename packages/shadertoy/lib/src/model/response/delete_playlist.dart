...
/// When [DeletePlaylistResponse.fail] is *not null* there was an error in the delete playlist call
/// When [DeletePlaylistResponse.fail] is *null* the delete was sucessful
