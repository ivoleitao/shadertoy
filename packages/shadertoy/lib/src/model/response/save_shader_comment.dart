...
/// When [SaveShaderCommentResponse.fail] is *not null* there was an error in the save shader comment call
/// When [SaveShaderCommentResponse.fail] is *null* the save was sucessful
